            ...
            <div className="step-view animate-fade-in">
              <div className="splunk-dashboard">
                ...
                <div className="splunk-content">
                  {/* Left Main Column: KPIs & Charts */}
                  <div className="splunk-main-col">
                      ...
                      <div className="chart-panel">
                        ...
                        <div className="bar-chart-list">
                          <div className="bar-row">
                            <span className="bar-label">Crit</span>
                      ...
                      <table className="splunk-table">
                        ...
                        <tbody>
                          <tr className="row-danger">
                            <td>14:32:05</td>
                            <td>Water High</td>
                            <td><span className="badge danger">CRIT</span></td>
                          </tr>
                          <tr>
                            <td>14:31:58</td>
                            <td>Pkt Drop</td>
                            <td><span className="badge warning">WARN</span></td>
                          </tr>
                          <tr>
                            <td>14:31:42</td>
                            <td>Link Down</td>
